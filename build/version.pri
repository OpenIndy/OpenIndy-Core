...
OpenIndyMath_VERSION = $$system(git --git-dir ../lib/OpenIndy-Math/.git describe --always --tags) # get git version
...
OpenIndyCore_VERSION = $$system(git --git-dir ../.git describe --always --tags) # get git version
