...
/*!
 * \brief Statistic::getDisplayResidual
 * \param elementId
 * \return
 */
Residual Statistic::getDisplayResidual(const int &elementId) const{
    return this->displayResidualsMap.value(elementId, Residual());
}
